...
SECRET_KEY = 'django-insecure-0_g!e)s**wosa&ozb*bumrhk^fhn5cjwvod4lkg1dg0k$5@o^k'
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "API documentation for the voting system built on Django and DRF.",
    "VERSION": "1.0.0",
